...
The extension does not sell, transfer, or share user data with third parties. It does not use analytics, advertising, tracking, or remote-code services.

## Network Requests

The extension does not send user data to an external server. It opens LinkedIn search pages only when the user clicks "Save and open search".
